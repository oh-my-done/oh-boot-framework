...
public class QRCodeFactory {
    ...
    public BufferedImage setMatrixLogo(BufferedImage matrixImage, String logUri) throws IOException {
        ...
        g2.setStroke(stroke);
        //指定弧度的圆角矩形
        RoundRectangle2D.Float round = new RoundRectangle2D.Float(matrixWidth / 5 * 4, matrixWidth / 5 * 4, matrixWidth / 5 * 4, matrixWidth / 5 * 4, 0, 0);
        ...
        RoundRectangle2D.Float round2 = new RoundRectangle2D.Float(matrixWidth / 5 * 4, matrixHeigh / 5 * 4, matrixWidth / 5 * 4, matrixWidth / 5 * 4, 0, 0);
        g2.setColor(Color.YELLOW);
     ...
     */
    public void CreatQrImage(String content, String format, String outFileUri, String logUri, Integer front, Integer background, int... size) throws IOException, WriterException {
        ...
        MatrixToImageWriter.writeToFile(bitMatrix, format, outputFile, logUri, front, background);
    }
}